        ...
        ?>
            <form action="editarUsuario.php?id=<?=$_GET['id']?>" method="post"" enctype="multipart/form-data" class="border p-4">
                ...
                <div>
                    ...
                    <input type="email" name="correo" class="form-control entrada" id="Correo" value="<?=$row['correo']?>">
                </div>

                <div class="my-2">
                    <select class="form-select" aria-label="Default select example" id="Tipo" name="tipo">
                        <option value="<?=$row['tipo']?>" selected>Selecione tipo de usuario</option>
                ...
                <div class="my-2">
                    <select class="form-select" aria-label="Default select example" id="Estado" name="estado">
                        <option value="<?=$row['estado']?>" selected>Selecione estado de usuario</option>
                ...
                <input type="submit" value="Actualizar" class="my-3">
                <div id="alerta"></div>
            </form>
