...
<body>
    ...
    <div class="container  mt-5">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card p-5 text-dark bg-light " id="continerLogin">
                ...
                <form id="formulario" action="../login/logear.php" method="post">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                        <button class="btn btn-outline-dark m-2" type="submit">Ingresar</button>
                        <a href="../usuarios/registrarUsuario.php" class="btn btn-outline-dark m-2">Registrarse</a>
                    </div>
                    <?=$loginErr;?>
                </form>
            </div>
